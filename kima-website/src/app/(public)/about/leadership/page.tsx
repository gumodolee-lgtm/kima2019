...
const ADVISORS = [
  { title: '고문', name: '허명호', org: '월드네이버 대표' },
  { title: '자문위원', name: '신상록', org: '함께하는다문화네트워크 이사장' },
  { title: '자문위원', name: '문창선', org: '위디선교회 대표' },
  { title: '자문위원', name: '허은열', org: '씨앗선교교회' },
  { title: '자문위원', name: '서기원', org: '부천몽골교회' },
  { title: '자문위원', name: '이승주', org: '탄자니아 선교사 / 귀국 후 이주민지원사역' },
  { title: '자문위원', name: '박찬식', org: '국제이주자선교포럼 대표' },
]

const EXECUTIVES = [
  { title: '상임대표', name: '남양규', org: '서울내이션즈교회' },
  { title: '공동대표', name: '최고수', org: '공촌교회' },
  { title: '공동대표', name: '안정호', org: '송우벗사랑베트남교회' },
  { title: '공동대표', name: '이동철', org: '삼목회' },
  { title: '공동대표', name: '오승재', org: '권능태국인교회 (천안)' },
  { title: '감사', name: '손승호', org: '울산·경남세계선교협의회 사무총장' },
  { title: '감사', name: '안명호', org: '할렐루야시니어 한국팀장' },
  { title: '훈련원장', name: '최고수', org: '한영대학교 이주민선교사훈련원' },
  { title: '사무총장', name: '홍광표', org: '새생명태국인교회' },
  { title: '사무부총장', name: '박세호', org: '킨미니스트리' },
  { title: '서기', name: '이병인', org: '엘림이주민센터' },
  { title: '부서기', name: '정유식', org: '네팔노동자교회' },
  { title: '회계', name: '이창호', org: '러브스리랑카교회' },
  { title: '부회계', name: '강은혜', org: '에스더기도운동 / Global Intercessory Network' },
]

const LANGUAGE_CHAIRS = [
  { title: '몽골위원장', name: '이해동', org: '다하나국제교회' },
  { title: '유학생위원장', name: '정재훈', org: '영락교회 유학생담당' },
  { title: '네팔위원장', name: '유병설', org: '광탄열방교회' },
  { title: '이슬람위원장', name: '안드레', org: '열무김치회장' },
  { title: '태국위원장', name: '윤윤경', org: '인천태국인교회' },
  { title: '스리랑카위원장', name: '이창호', org: '러브스리랑카교회' },
...
const REGION_CHAIRS = [
  { title: '경기남부 지역위원장', name: '이민기', org: '평택 쉼터교회' },
  { title: '경기서부 지역위원장', name: '안드레', org: '베이튼누루센터' },
  { title: '경기북부 지역위원장', name: '김광현', org: '동두천예수사랑교회' },
  { title: '호남 지역위원장', name: '김창식', org: '하나되는 교회 / 물댄동산다문화센터' },
  { title: '충청 지역위원장', name: '권정현', org: '싼티팝코리아태국인교회 (천안)' },
  { title: '강원 지역위원장', name: '노인국', org: '영월서머나교회' },
  { title: '제주 지역위원장', name: '한용길', org: '사)제주외국인평화공동체' },
]

const DENOMINATION_REPS = [
  { title: '합동교단 대표', name: '최규정', org: '인천올프렌즈교회' },
  { title: '백석교단 대표', name: '허은열', org: '씨앗선교회 대표' },
  { title: '통합교단 대표', name: '도주명', org: '전주 온교회' },
  { title: '순복음교단 대표', name: '이익성', org: '이주민월드비전교회' },
  { title: '침례교단 대표', name: '장인식', org: '침례교해외선교회 (지구촌교회파송)' },
  { title: '대신교단 대표', name: '박만규', org: '세종시' },
  { title: '고신교단 대표', name: '강하전', org: '부산 중국인 유학생 선교사' },
  { title: '합신교단 대표', name: '박용수', org: '용인대 중국인 유학생 선교사' },
  { title: '기장교단 대표', name: '이정혁', org: '' },
]

const NETWORK_CHAIRS = [
  { title: '현지인사역자네트워크위원장', name: '하니프', org: '한국미술인선교회 선교사' },
  { title: '지역교회네트워크위원장', name: '김귀희', org: '사랑의 교회, 디아스포라 고문' },
]

function MemberCard({ title, name, org }: { title: string; name: string; org: string }) {
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 flex items-start gap-4">
      ...
      <div className="min-w-0">
        ...
        <p className="text-base font-bold text-gray-900 mt-0.5">{name}</p>
...
function Section({ title, members }: { title: string; members: { title: string; name: string; org: string }[] }) {
  return (
